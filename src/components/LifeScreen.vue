<template>
  <div>
    ...
    <div class="box large-box text-box">
      <p>
        This is <em>Life+</em>, a celluar automaton which is essentially
        Conway's Game of Life with a bunch of extra rules and cell states. My
        overall goal is to see how much needless complexity I can fit into the
        automaton while still making it seem (and feel) like the original Game
        of Life. Why have I done this? you might ask. I really don't know. But
        it's here now and it's kind of amusing so I guess it worked out.
      </p>
      <p>
        Below this paragraph I've written up a very condensed set of rules. If
        you're not familiar with Conway's Game of Life, you'll probably have a
        hard time understanding what I've written. Actually, you'll probably
        have a hard time regardless. Good luck! :)
      </p>
      <p><b>Cell Types:</b></p>
      <ul>
        <li>Normal (white)</li>
...
export default {
  ...
  methods: {
    run() {
      ...
      // Triggers init() once the page elements are fully loaded
